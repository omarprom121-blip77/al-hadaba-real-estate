...
export async function GET(_request, { params }) {
  try {
    ...
    if (!id || !ObjectId.isValid(id)) return json({ success: false, error: 'المشروع غير موجود أو لم يعد منشورًا.' }, 404);
    ...
    if (!item) return json({ success: false, error: 'المشروع غير موجود أو لم يعد منشورًا.' }, 404);
    ...
    return json({ success: false, error: 'تعذر تحميل بيانات المشروع حاليًا.' }, 500);
  }
}
